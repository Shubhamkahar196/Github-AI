...
const IssueList = ({meetingId}: Props) => {
    const {data: meeting, isLoading} = api.project.getMeetingId.useQuery({meetingId},{
            ...
            <div className='mx-auto flex max-w-2xl items-center justify-between gap-x-8 border-b pb-6 lg:mx-0 lg:max-w-none'>
                    <div className='flex items-center gap-x-8'>
                        <div className='rounded-full border bg-white p-3'>
                         ...
                         <h1>
                            <div className='text-sm leading-0 text-gray-600'>
...
function IssueCard ({issue}: {issue: NonNullable<RouterOutputs["project"]["getMeetingId"]>["issues"][number]}) {
